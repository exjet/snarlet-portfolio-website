...
<a class="navbar-brand" href="index.html">Scarlet Thibodeau </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover" style="display: none;"><a class="nav-link" href="experience.html">Experience</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="projects.html">Projects</a></li>
   <li class="nav-item nav-item-hover" style="display: none;"><a class="nav-link" href="research.html">Research</a></li>
   <li class="nav-item nav-item-hover"><a class="nav-link" href="aboutme.html">About Me</a></li>
   <li class="nav-item nav-item-hover" style="display: none;"><a class="nav-link" href="https://hashnode.com/" target="_blank">Blogs</a></li>
   <li class="nav-item">
   <input type="checkbox" id="dark_toggler" class="dark_toggler" aria-label="Toggle Light Mode" onclick="toggle_light_mode()" checked>
   </li>
   <div class="bike">
     <img src="assets/images/project-page/Website_Profile_Picture_Head.png" alt="Profile" class="mobile-menu-image" />
   </div>
  </ul>
</div>
</nav>`);
...
<footer class="footer sticky-bottom"  style="background-color:#2b2a2a;">
  <div class="p-4">
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 justify-content-center">
          <style>
            ...
            .giant-merp {
              ...
              width: 300px;
              height: 300px;
              background: url('assets/images/project-page/Website_Profile_Picture_Head.png') center/contain no-repeat;
              z-index: 1;
              animation: 1.5s Infinite linear floating-merp;
            }
            .scarlet-character {
              position: absolute;
              width: 200px;
              height: 200px;
              background: url('assets/images/home/Website_Profile_Picture_Head.png') center/contain no-repeat;
              z-index: 2;
              bottom: 80px;
              animation: 1.5s Infinite linear floating-scarlet;
            }
            @keyframes floating-merp {
              0% {
          ...
          <div class="contact-character-container">
            <div class="giant-merp"></div>
            <div class="scarlet-character"></div>
          </div>
        </div>
        ...
        <div class="col-lg-6 col-md-12 mb-4 mb-md-0 form-comtainer">
          <div class="form-style-6">
             <div class="form-header">
                ...
                <form name="form1" action="https://formcarry.com/s/9YeWv8Q-m8p" method="POST" accept-charset="UTF-8" >
    ...
    <a class="social-button linkedin" href="" target="_blank" style="display: none;">
    ...
    <a class="social-button instagram" href="https://www.instagram.com/snarloid_prime/" target="_blank" >
    ...
    <a class="social-button github" href="#" target="_blank" style="display: none;">
  ...
  $(window).scroll(function () {
    ...
    if ($(window).scrollTop() < $(window).height()) {
      ...
      if (
        ...
        $("#btnScrollToTop").css("background-color", "#d93581");
      } else {
        $("#btnScrollToTop").css("background-color", "#d93581");
      }
    }
